...
class Invoice
{
     ...
     * @Groups({"invoices_read", "customers_read", "invoices_subresource"})
     * @Assert\NotBlank(message="Le statut de la facture doit être renseignée.")
     * @Assert\Choice({"SENT","PAID","CANCELLED"}, message="le statut doit être SENT, PAID ou CANCELLED.")
     */
    private $status;
